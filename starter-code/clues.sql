...
SELECT countrycode FROM countrylanguage WHERE language = 'Italian' AND percentage = 100.0;
...
SELECT name, countrycode FROM city WHERE name LIKE '%Serra%' AND name NOT LIKE '%San Marino' LIMIT 1;
...
SELECT city.name FROM city JOIN country ON city.id = country.capital WHERE country.code = 'BRA';
